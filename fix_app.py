...
content = content.replace("import AudioPlayer from './components/AudioPlayer';", "import AudioPlayer from './components/AudioPlayer';\n" + import_stmt)
...
"""
content = content.replace("const MOCK_PREDICTED_QUESTIONS", mock_data + "\nconst MOCK_PREDICTED_QUESTIONS")
